  ...
  return (
    <div className="bg-[#18191b] min-h-screen w-full">
        ...
        <div className="w-[93%] m-auto py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  setType("signin"), setShow(true);
                }}
                className="py-2 w-[80px] text-center bg-teal-700 text-white transation-all hover:bg-teal-500 rounded-[5px] font-medium"
              >
                SignIn
              </button>
              <button
                onClick={() => {
                  setType("signup"), setShow(true);
                }}
                className="py-2 w-[80px] text-center bg-purple-700 text-white transation-all hover:bg-purple-500 rounded-[5px] font-medium"
              >
                SignUp
              </button>
            </div>
      ...
      <div className="w-full h-full justify-center items-center p-4">
        <div className="py-[420px] flex justify-center items-center flex-col gap-6">
          ...
          <button
            ...
            className="py-2 w-[200px] text-center bg-purple-700 text-white transation-all hover:bg-purple-500 rounded-[5px] font-medium"
          >
            SignUp for Free
          </button>
        </div>
